...
public class Flamethrower : MonoBehaviour
{
    ...
    public bool IsOnFlames { get { return _isOnFlames; } /*set { _isOnFlames = value; }*/ }
    ...
    private bool _isOnFlames = false;
    ...
    {
        if (_flamethrowerCooldownCoroutine != null || _isOnCooldown)
        {
        ...
        if (_flamethrowerCoroutine != null || _isOnFlames)
        {
